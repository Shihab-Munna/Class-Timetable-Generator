...
class Course(models.Model):
    ...
    course_type = models.CharField(
        max_length=200, null=True, choices=COURSE_TYPE)
...
#     )
#     course_name = models.CharField(max_length=1000, null=True)
#     day = models.CharField(max_length=1000, null=True, choices=DAYS_OF_WEEK)
#     time_slot = models.CharField(maxnull=True)
...
class Classroom(models.Model):
    ...
    classroom_type = models.CharField(
        max_length=2000, null=True, choices=CLASSRoom_TYPE)
...
class ClassCourse(models.Model):
    ...
    professor_id = models.ForeignKey(
        Professor, null=True, on_delete=models.CASCADE)
...
class Activity(models.Model):
    ...
    activity_type = models.CharField(
        max_length=2000, null=True, choices=ACTIVITY_TYPE)
...
class Routine(models.Model):
    ...
    course_details = models.CharField(max_length=2000, null=True)
