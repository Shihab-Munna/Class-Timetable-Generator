...
urlpatterns = [
    ...
    path('get-professor/', views.GetProfessorView, name='add-professor'),
    ...
    path('update-professor/<str:pk>/',
         views.updateProfessorView, name='update-professor'),
    path('update-classroom/<str:pk>/',
         views.updateClassroomView, name='update-classroom'),
    ...
    path('delete-professor/<str:pk>/',
         views.deleteProfessor, name='delete-professor'),
    path('classroom_view/', views.ClassroomTable, name='classroom-view'),
    path('delete-classroom/<str:pk>/',
    ...
    path('add-routine/', views.AddRoutine, name='add-routine'),
    path('validate-routine/', views.ValidateRoutine, name='validate-routine'),
    path('view-all-routines/', views.ViewAllRoutines, name='view-all-routines'),
    path('print-routine/<str:semester_type>/',
         views.PrintRoutine, name='print-routine'),
]
